...
\begin{proof}
由\ref{sample-mean-distribution}和\ref{sample-variance-and-variance}可知
$$
...
\begin{proposition}
\rm 设$X_1,X_2,\cdots,X_n$与$Y_1,Y_2,\cdots,Y_n$分别来自正态总体分布$N(\mu_1,\sigma_1^2)$及$N(\mu_2,\sigma_2^2)$，且这两个样本相互独立. 则有
$$
