...
$$
F(x_1,x_2,\cdots,x_n) = \int_{-\infty}^{x_1}\int_{-\infty}^{x_2}\cdots\int_{-\infty}^{x_n}f(v,u,\cdots,w)dv1du\cdots dw.
$$
...
\begin{definition}
\rm 设$(X,Y)$有概率密度$f(x,y)$，我们考虑在给定$y \leq X \leq y+\varepsilon$的条件下$X$
\end{definition}
